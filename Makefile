...
KIND_CLUSTER ?= alloy-remote-config-test-e2e
...
HELM_NAMESPACE ?= alloy-remote-config-system
## Name of the Helm release
HELM_RELEASE ?= alloy-remote-config
## Path to the Helm chart directory
HELM_CHART_DIR ?= charts/fleet-management
